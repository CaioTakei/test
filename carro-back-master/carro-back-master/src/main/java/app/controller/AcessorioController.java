...
public class AcessorioController {
	...
	public ResponseEntity<Page<Acessorio>> findAll(
			@PathVariable("numPage") int numPage,
			@PathVariable("qtidPorPagina") int qtidPorPagina){
		Page<Acessorio> lista = this.acessorioService.findAll(numPage, qtidPorPagina);
